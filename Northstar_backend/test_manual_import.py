...
class ManualImportTests(unittest.TestCase):
    ...
    def test_imported_cache_integrates_with_scanner_imported_fields_usable(self):
        ...
        self.assertEqual(product["enrichment_status"], "offline_mode")
    ...
    def test_provider_rows_without_imported_at_keep_offline_behavior(self):
        ...
        the manual-import overlay: bare offline placeholder behavior — with
        the precise status no_provider_configured (no enrichment provider is
        configured to serve this plain cache row)."""
        existing = [{
        ...
        self.assertEqual(product["enrichment_status"], "no_provider_configured")
