...
def _opportunity_entry(o: ScoredOpportunity) -> Dict[str, Any]:
    ...
    return {
        ...
        "financial_breakdown": {
            ...
            "buy_box_price": _round2(eco.buy_box_price),
            "undercut_headroom": _round2(eco.undercut_headroom),
            "max_undercut_price": _round2(eco.max_undercut_price),
        },
        "scoring": {
            ...
            "price_gap_score": round(o.price_gap_score, 4),
            "ad_feasibility_score": round(o.ad_feasibility_score, 4),
            "tier": o.tier,
            "tags": list(o.opportunity_tags),
            "ad_feasibility_breakdown": dict(o.ad_feasibility_breakdown),
        },
